...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اضافه معلومة</h4>
            </div>
        </div>
        @can('about-list')
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('abouts.store') }}" class="needs-validation" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    @foreach (config('app.languages') as $key => $lang)
                                        <div class="tab-pane mt-3 fade @if ($loop->index == 0) show active in @endif" 
                                            ...
                                            <div class="form-group mt-3 col-md-12">
                                                ...
                                                <input type="text" name="{{$key}}[desc]" class="form-control" placeholder="المحتوى">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>

...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">معلومات عنا</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                معلومات عنا</span>
        </div>
    </div>
    {{-- @can('about-create') --}}
                    ...
                    <table class="table table-hover  text-md-nowrap" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">اسم المعلومة</th>
                                <th class="wd-15p border-bottom-0">محتوى المعلومة </th>
                                <th class="wd-15p border-bottom-0">صورة المعلومة</th>
                                <th class="wd-15p border-bottom-0">حالة المعلومة </th>
                            ...
                            @if ($abouts->count()>0)
                             @foreach ($abouts as $about)
                                <tr>
                                    ...
                                    <td>{{ $about->title }}</td>
                                    <td>{{ $about->desc }}</td>
                                    {{-- <td><img src="{{ asset('images/partners/' . $partner->logo) }}" alt="Partner Logo"></td> --}}
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('abouts.edit', $about->id) }}" class="btn btn-sm btn-info"
                                            title="تعديل"><i class="las la-pen"></i></a>
                                        {{-- @endcan --}}
                                        {{-- @can('about-delete') --}}
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-user_id="{{ $about->id }}" data-username="{{ $about->title }}"
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('abouts.destroy',0) }}" method="post">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <p>هل انت متاكد من عملية الحذف ؟</p><br>
                        <input type="hidden" name="about_id" id="user_id" value="">

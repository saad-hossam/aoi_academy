...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الشهادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                    الشهادات</span>
            </div>
        </div>
        ...
        @can('certificate-create')
            ...
            <div class="d-flex my-xl-auto right-content">
                <a class="btn btn-primary btn-block" href="{{ route('certificates.create') }}">اضافه شهادة</a>
            </div>
        @endcan
    </div>
    <!-- breadcrumb -->
                        ...
                        <table class="table table-hover  text-md-nowrap" id="example1" data-page-length='50'
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">اسم الشهادة</th>
                                    <th class="wd-15p border-bottom-0">صورة الشهادة</th>
                                    <th class="wd-15p border-bottom-0">حالة الشهادة </th>
                                ...
                                @if ($certificates->count() > 0)
                                    @foreach ($certificates as $certificate)
                                        <tr>
                                            ...
                                            {{-- <td><img src="{{ asset('images/certificates/' . $certificate->logo) }}"
                                                    alt="certificate Logo"></td> --}}

                                            <td><img src="{{ asset('images/certificates/' . $certificate->image) }}" alt=""></td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                @can('certificate-delete')
                                                    ...
                                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                        data-user_id="{{ $certificate->id }}" data-username="{{ $certificate->title }}"
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('certificates.destroy', 0) }}" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                        <div class="modal-body">
                            <p>هل انت متاكد من عملية الحذف ؟</p><br>
                            <input type="hidden" name="certificate_id" id="user_id" value="">

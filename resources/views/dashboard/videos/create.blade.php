...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">اضافه فيديو</h4>
            </div>
        </div>
...
@section('content')
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('videos.store') }}" class="needs-validation ">
                        @csrf
                                    ...
                                    @foreach (config('app.languages') as $key => $lang)
                                        <div class="tab-pane mt-3 fade @if ($loop->index == 0) show active in @endif"
                                            ...
                                            <div class="form-group mt-3 col-md-12">
                                                <label> عنوان الفيديو-- {{ $lang }}</label>
        ...
        <div class="col-md-6 mg-t-20">
            ...
            <input type="text" class="form-control" name="link" id="link" placeholder="ضع رابط الفيديو هنا">
        </div>

        {{-- Video Order --}}
        <div class="col-md-6 mg-t-20">
            <label class="form-label h5" for="order">ترتيب الفيديو</label>
            <input type="number" class="form-control" name="order" id="order" value="0" placeholder="ادخل ترتيب العرض">
        </div>


                            <div class="col-md-6 mg-t-20 mg-md-t-0 mt-2">
                                <label class="form-lable h5" for="status">حاله الفيديو</label>

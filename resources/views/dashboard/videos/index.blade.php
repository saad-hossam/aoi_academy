...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">مكتبة الفيديوهات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    قائمة
                    مكتبة الفيديوهات</span>
            </div>
        </div>
      ...
      @can('video-create')
        ...
        <div class="d-flex my-xl-auto right-content">
            <a class="btn btn-primary btn-block" href="{{ route('videos.create') }}">اضافه فيديو</a>
        </div>
            @endcan
                        ...
                        <table class="table table-hover  text-md-nowrap" id="example1" data-page-length='50'
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">اسم الفيديو</th>
                                    <th class="wd-15p border-bottom-0">رابط الفيديو</th>
                                    <th class="wd-15p border-bottom-0">عدد مشاهدات الفيديو </th>
                                    <th class="wd-15p border-bottom-0"> ترتيب ظهور الفيديو </th>

                                    <th class="wd-15p border-bottom-0">حالة الفيديو </th>
                                ...
                                @if ($videos->count() > 0)
                                    @foreach ($videos as $video)
                                        <tr>
                                            <td>{{ $video->id }}</td>
                                            <td>{{ $video->title }}</td>
                                            {{-- <td><img src="{{ asset('images/videos/' . $video->logo) }}" alt="video Logo"></td>
                                            --}}
                                            ...
                                            <td>
                                                ...
                                                <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                    data-user_id="{{ $video->id }}" data-username="{{ $video->title }}"
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('videos.destroy', 0) }}" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                        <div class="modal-body">
                            <p>هل انت متاكد من عملية الحذف ؟</p><br>
                            <input type="hidden" name="video_id" id="user_id" value="">

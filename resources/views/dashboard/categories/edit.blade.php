...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تعديل الفئات</h4>
            </div>
        </div>

        <div class="d-flex my-xl-auto right-content">
            <a class="btn btn-primary btn-block" href="{{ route('categories.index') }}">جميع الفيديوهات</a>
        </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('categories.update', $category->id) }}"
                        ...
                        <div class="col-md-6 mg-t-20">
                            <label class="form-label h5" for="order">ترتيب ظهور الفئة</label>
                            <input type="text" value="{{ $category->order ?? '' }}" class="form-control" name="order"
                                id="order" placeholder="ضع رابط الفيديو هنا">
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select id="status" name="status" class="form-control select2">
                                        <option value="active" {{ $category->status == 'active' ? 'selected' : '' }}>مفعل
                                        </option>
                                        <option value="disabled" {{ $category->status == 'disabled' ? 'selected' : '' }}>غير
                                            مفعل
                                        </option>
                                    </select>
                                </div>

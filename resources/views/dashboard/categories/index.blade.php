...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفئات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    قائمة
                    الفئات</span>
            </div>
        </div>
        ...
        <div class="d-flex my-xl-auto right-content">
            <a class="btn btn-primary btn-block" href="{{ route('categories.create') }}">اضافه فئة</a>
        </div>
          @endcan
                        ...
                        <table class="table table-hover  text-md-nowrap" id="example1" data-page-length='50'
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0"> ترتيب ظهور الفئة </th>

                                    <th class="wd-15p border-bottom-0">حالة الفئة </th>
                                ...
                                @if ($categories->count() > 0)
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            {{-- <td><img src="{{ asset('images/categories/' . $category->logo) }}" alt="category Logo"></td>
                                            --}}
                                            ...
                                            <td>
                                                ...
                                                <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                    data-user_id="{{ $category->id }}" data-username="{{ $category->title }}"
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('categories.destroy', 0) }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="category_id" id="user_id" value="">

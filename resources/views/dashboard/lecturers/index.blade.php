...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المحاضرين</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                    المحاضرين</span>
            </div>
        </div>
...
@can('lecturer-create')
            ...
            <div class="d-flex my-xl-auto right-content">
                <a class="btn btn-primary btn-block" href="{{ route('lecturers.create') }}">اضافه محاضر</a>
            </div>
            @endcan
                        ...
                        <table class="table table-hover  text-md-nowrap" id="example1" data-page-length='50'
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">اسم المحاضر</th>
                                    <th class="wd-15p border-bottom-0">صورة المحاضر</th>
                                    <th class="wd-15p border-bottom-0">حالة المحاضر </th>
                                ...
                                @if ($lecturers->count() > 0)
                                    @foreach ($lecturers as $lecturer)
                                        <tr>
                                            ...
                                            {{-- <td><img src="{{ asset('images/lecturers/' . $lecturer->logo) }}"
                                                    alt="lecturer Logo"></td> --}}

                                            <td><img src="{{ asset('images/lecturers/' . $lecturer->image) }}" alt=""></td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                @can('lecturer-delete')
                                                    ...
                                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                        data-user_id="{{ $lecturer->id }}" data-username="{{ $lecturer->title }}"
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('lecturers.destroy', 0) }}" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                        <div class="modal-body">
                            <p>هل انت متاكد من عملية الحذف ؟</p><br>
                            <input type="hidden" name="lecturer_id" id="user_id" value="">

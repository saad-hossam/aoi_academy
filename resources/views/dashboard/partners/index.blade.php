...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">شركاء النجاح</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                شركاء النجاح</span>
        </div>
    </div>
                            ...
                            @if ($partners->count()>0)
                             @foreach ($partners as $partner)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('images/partners/' . $partner->image) }}" alt=""></td>
                                    <td>
                                    ...
                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-user_id="{{ $partner->id }}" data-username="{{ $partner->title }}"
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('partners.destroy',0) }}" method="post">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
